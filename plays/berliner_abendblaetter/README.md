...
- **[Playbook](play_berliner_abendblaetter.md)**: Die Definition und Struktur des Stücks nach ENACTS.
- **Charaktere & Rollen**:
  - [Kleist](persona_kleist.md) (Herausgeber)
  - [Gruner](persona_gruner.md) (Informant)
  - [Leser](persona_leser.md) (Publikum)
  - [Zensor](persona_zensor.md) (Zensurbehörde)
- **Die Bühne**:
  - [Druckerei](place_druckerei.md): Der Berliner Druckort der Abendblätter.
  - [Abendblatt](piece_abendblatt.md): Das täglich gedruckte, brisante Nachrichtenblatt.
- **Der Prozess**:
  - [Zensur-Kollaps](plot_zensur_kollaps.md): Der Zusammenstoß des Redakteurs mit der preußischen Zensur.
  - [Vertrieb](plan_vertrieb.md): Der tägliche Plan zur Herausgabe und Abonnentengewinnung.
  - [Nachrichtenfluss](process_nachrichtenfluss.md): Der systemische Kreislauf von rohen Informationen zu gedruckten Anekdoten.
