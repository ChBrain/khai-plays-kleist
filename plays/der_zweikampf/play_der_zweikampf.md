...
- Personas:
  ...
  - [Littegarde](persona_littegarde.md)
  - [Rotbart](persona_rotbart.md)
- Positions:
  - [Herausforderer](position_herausforderer.md)
  - [Verleumdete](position_verleumdete.md)
  - [Beklagter](position_beklagter.md)
- Places:
  - [Kampfplatz](place_kampfplatz.md)
- Pieces:
  - [Schwert](piece_schwert.md)
- Plots:
  - [Gottesurteil](plot_gottesurteil.md)
- Plans:
...
Die Ermordung des Herzogs Wilhelm, die falsche Anschuldigung Littegardes durch Jakob den Rotbart zur Deckung seines Alibis, und die Bereitschaft Friedrichs, für ihre Unschuld in den Kampf zu ziehen.

## Stakes

Das Vertrauen in die göttliche Gerechtigkeit und das Prinzip des Gottesurteils, die Wiederherstellung von Littegardes verletzter Ehre, und die Aufdeckung des rechtmäßigen Erben von Breisach.
