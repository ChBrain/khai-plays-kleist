...
- The Theatre Manager (persona: tieck, defined in `management/`) runs the day-to-day operations and ensures all changes in this repository conform to the gates.
- The Playwright (persona: kleist) writes the plays and shapes the art.
...
- Works exclusively within the `khai-plays-kleist` repository.
