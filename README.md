...
The Kleist production house: a collection of khai plays, each a
production staged with khai, dedicated to Heinrich von Kleist.
...
Content is CC-BY-NC-SA, code is MIT (`LICENSE`, `LICENSE-CODE`). Kleist
